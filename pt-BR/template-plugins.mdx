...
O Pingo Notify transforma eventos (como "Novo Pedido") em notificações automáticas personalizadas.
...
2.  **Conexão:** Qual conta conectada da sua loja enviará a mensagem.
