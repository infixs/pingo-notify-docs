...
<Info>
  O plugin funciona apenas como **ponte** entre o WordPress e o Pingo Notify.  
  Ele não envia mensagens por conta própria.
</Info>
...
Para usar o plugin, é preciso ter um plano ativo no Pingo Notify.

<Info>
  Você pode **começar com um plano gratuito**, que permite integrar o plugin e testar o envio de notificações.
</Info>

Planos pagos estão disponíveis caso você precise de mais capacidade.
